...
<!-- Relatório de saída -->
<div class="modal fade" id="outputReport" tabindex="-1" role="dialog" aria-labelledby="modalFormOutputReport" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalFomrentryReport" style="font-weight: bold; color: #ff5400">Relatório de saída</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body modalFormGif">
                <div class="form-entryProduct">
                    <form method="POST" action="{{ route('reportOutput') }} " id="logoutOutPut-form" class="form_outPutProduct" id="form_outPutProduct">
                        @csrf
                        <div class="mb-3">
                            <label for="dateIni" class="form-label">Data Inicial</label>
                            <input type="text" class="form-control" id="dateIni" name="dateIni" aria-describedby="dateIni" placeholder="01/01/2022">
