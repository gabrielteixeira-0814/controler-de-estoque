<table class='table'>
    ...
    @foreach ($listEntryProduct as $entryProduct)
        <tr>
            ...
            <td>
                <button class='edit actionButton' id='entryProductId' value="{{ $entryProduct->id }}" name="{{ $entryProduct->id }}" data-toggle="modal" data-target="#itemEntryProduct" data-toggle="tooltip" data-placement="top" title="Adicionar Itens" style="color: #0099B2; font-size: 20px;"><i class='bx bxs-up-arrow-alt'></i></button>
