...
@section('content')
    <div class="container mt-5">
        ...
        <div class="h2 pt-5" style="font-weight: bold; color: #ff5400">Requisição de Produto</div>
        <div class="row bg-white rounded px-3">
            ...
            <div class="col-6 py-3 text-end">
                <button type="button" class="btn btn-success createUser" data-toggle="modal" data-target="#userForm" >Requisição <i class='bx bx-clipboard nav_icon' style="font-size: 15px"></i></button>
            </div>
            <div class="requisitionProduct_data"></div>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ asset('js/requisitionProduct.js') }}" defer></script>
@endsection
